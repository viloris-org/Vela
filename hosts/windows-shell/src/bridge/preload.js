/**
 * Phase 4 Windows preload subset for hosts/windows-shell.
 * Keep {type:req|res|event} payloads in sync with:
 *   hosts/linux-shell/scripts/preload.js
 *   hosts/desktop-shell/Sources/VelaShell/Resources/preload.js
 *
 * Transport differs:
 *   - WebKit:  window.webkit.messageHandlers.vela.postMessage
 *   - WebView2: chrome.webview.postMessage (when host injects this script)
 */
(function () {
