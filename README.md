...
> **Status**: architecture and shared TypeScript contracts. Hosts (Bun desktop shell, iOS/Android) are not implemented yet.  
> **Status**: architecture and shared TypeScript contracts. Hosts (Bun desktop shell, iOS/Android) are not implemented yet.

Bun-centered GUI framework for **desktop and mobile**:
