...
Staged plan to grow New_Vela from **contracts + ADR** into a cross-platform
WebView-first GUI framework with Qt-class composition.
...
Acceptance for composition is described in the domain docs and
...
- [ ] Native Shell prototype (window + WKWebView)
...
- [ ] ADR 0002: IPC / typed RPC and privilege boundaries (Tauri Commands/Events map)  
...
- [x] Tauri comparison (process / IPC / security) — [tauri-comparison.md](tauri-comparison.md)  
